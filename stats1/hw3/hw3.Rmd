...
- The intercept (13.923514) represents the predicted percentage of protected land area when the state capacity score is 0. However, this value may not be substantively meaningful because a state capacity score of 0 may not be realistic or applicable in real-world scenarios.
...
The predicted percentage of land under protection in a country with a state capacity of 3 is approximately 25.54%. This predicted value can be assigned substantive meaning as it provides an estimate of the extent of land protection based on the state capacity score. However, it is important to consider the context and limitations of the model, such as the range of state capacity scores in the data and potential confounding factors that may influence land protection.
...
To determine which regression model provides better predictions of annual earnings within the sample, we can compare the R-squared values of both models. The model with the higher R-squared value indicates a better fit to the data, as it explains a larger proportion of the variance in the dependent variable (percent of protected land area).
